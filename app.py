...
def require_password():
    ...
    Evita hardcode in repo.
    """
    expected = st.secrets.get("APP_PASSWORD", "")  # <-- usa secrets
    # fallback per test locale: expected = expected or "bingo2807"
